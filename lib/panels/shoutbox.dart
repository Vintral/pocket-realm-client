...
class _ShoutboxPanelState extends ListPanelState<ShoutboxPanel> {
  ...
  void initState() {
    ...
    _onShoutSuccessListener = _provider.on( "SHOUT_SUCCESS", null, onShoutSuccess );
  ...
  Widget buildResults() {
    ...
    for( var shout in _provider.shouts ) {      
      widgets.add( Shout(avatar: shout.avatar, username: shout.username, time: shout.time, message: shout.shout, characterClass: shout.characterClass, ) );
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(                
                  ...
                  child: Button( text: Dictionary.get( "SHOUT" ), handler: onTap, largeFont: true, enabled: _enabled, ),
                ),
              ),
            ],
          ),
