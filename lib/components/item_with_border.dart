...
class ItemWithBorder extends StatelessWidget {
  ItemWithBorder({super.key, this.item, this.image, this.color, this.backgroundColor, this.handler, this.width, this.height, this.padding, this.active = false, this.quantity, this.reflect = false });
      ...
      child: GestureDetector(
        ...
        child: Stack(
          children: [
            ...
            ColorFiltered(
              colorFilter: ColorFilter.mode(
                active ? _theme.activeBorderColor 
                  : ( color != null ? color as Color : _theme.inactiveBorderColor ),
                BlendMode.modulate
              ),
              child: Image.asset( "assets/ui/frame.png", ),
            ),
            quantity != null ?
              Container(
                color: active ? _theme.activeBorderColor : _theme.inactiveBorderColor,
                padding: EdgeInsets.all( _theme.quantityPadding ),
                child: Text( quantity as String, style: _theme.styleQuantitySmall ),
              ) : Container()
          ],
        ),
      ),
