  ...
  Widget build( BuildContext context ) {
    ...
    Widget ret = Container(
      ...
      child: Row(
        ...
        children: [
          ItemWithBorder( image: "assets/avatars/${data.avatar}.png", height: size, ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text( data.username, style: _theme.styleShoutUsername ),
                      Text( timeSince( data.updated ), style: _theme.styleShoutDate ),
                    ],
                  ),
                  SizedBox( height: _theme.gap / 2 ),
                  !data.reply ?
                    Text( data.message, style: _theme.styleConversationMessage ) :
                    //Text( "Replied: ${data.message}", style: _theme.styleShoutMessage ),
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan( text: "${Dictionary.get( "REPLIED" ).capitalize()}: ", style: _theme.styleConversationReplied ),
                          TextSpan( text: data.message, style: _theme.styleConversationRepliedMessage )
                        ]
                      )
                    ),
                ],
